...
import { BreadCrumpstyls } from "./classNames";
...
const BreadcrumbList = forwardRef<HTMLOListElement, ComponentPropsWithoutRef<"ol">>(({ ...props }, ref) => (
  <ol ref={ref} className={BreadCrumpstyls.container} {...props} />
));
